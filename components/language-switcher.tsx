...
const pillClass =
  "flex shrink-0 gap-1 rounded-full border border-stone-200/90 bg-white/95 p-1 shadow-md backdrop-blur-sm dark:border-stone-600 dark:bg-stone-900/95";
      ...
      {FLAGS.map(({ locale: loc, emoji, labelKey }) => {
        ...
        return (
          <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-full text-lg leading-none transition touch-manipulation active:scale-95 ${
              active
